...
namespace CineTicket.Migrations
{
    ...
    [Migration("20251019095607_update_rap")]
    partial class update_rap
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CineTicket.Models.PhongChieu", b =>
                {
                    ...
                    b.Property<int?>("MaBnNavigationMaRap")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MaBnNavigationMaRap");

                    b.ToTable("PhongChieu", (string)null);
                });

            modelBuilder.Entity("CineTicket.Models.Rap", b =>
                {
                    b.Property<int>("MaRap")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CineTicket.Models.PhongChieu", b =>
                {
                    b.HasOne("CineTicket.Models.Rap", "MaBnNavigation")
                        .WithMany()
                        .HasForeignKey("MaBnNavigationMaRap");
